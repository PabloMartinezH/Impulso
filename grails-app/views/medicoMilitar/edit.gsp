...
<form id="formupdatemedicoMilitar">
  <g:hiddenField name="id" value="${medicoMilitarInstance?.id}" />
  <g:hiddenField name="version" value="${medicoMilitarInstance?.version}" />
  ...
  <div class="nav">
    <span class="menuButton">
    <a href="#" class="save" onclick="javascript:sabEntidad('medicoMilitar','update');">
      <g:message code="default.button.update.label" default="Update"/>
    </a>
  </span> 
    <span class="menuButton">
    <a href="#" class="delete" onclick="javascript:confirmacionSab('medicoMilitar','delete');">
